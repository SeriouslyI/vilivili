...
function listall(){
	...
	$name = $rowi['name'];
	$sql = "select*from up_video where v_type = 0";
		...
		<div class="center">
			<div class="security-left">
				...
				<ul class="security-ul">
					<li class="security-list on" onclick="document.location.href='backstage.php'"><span class="security-nav-name">视频审核</span></li>
					<li class="security-list over" onclick="document.location.href='dhvideo.php'"><span class="security-nav-name">动画管理</span></li>
			...
			<div class="security-right">
				<div class="security-right-title">
					<span class="security-right-title-text">视频审核</span>
				</div>
    			...
    			<?php while ($item = mysqli_fetch_assoc($query)): ?>
    				<div class="video">
						...
						<div class="isupload" style="background-color:#00CC33;cursor: pointer;">
							<a href="php/agree.php?id=<?php echo $item['v_id']; ?>">通过</a>
						</div>
						<div class="delete">
							<a href="php/disagree.php?v_url=<?php echo $item['v_url'] ?>&id=<?php echo $item['v_id'] ?>">不通过</a>
						</div>
						</div>
						</div>
					</div>
