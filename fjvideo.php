...
function listall(){
	...
	$name = $rowi['name'];
	$sql = "select*from up_video where v_class = 2 and v_type = 1";
		...
		<div class="center">
			<div class="security-left">
				...
				<ul class="security-ul">
					...
					<li class="security-list on" onclick="document.location.href='fjvideo.php'"><span class="security-nav-name">番剧管理</span></li>
			...
			<div class="security-right">
				<div class="security-right-title">
					<span class="security-right-title-text">番剧管理</span>
				</div>
