		...
		<div class="center">
			<div class="security-left">
				...
				<ul class="security-ul">
					...
					<li class="security-list on" onclick="document.location.href='dyvideo.php'"><span class="security-nav-name">电影管理</span></li>
				</ul>
			</div>
			<div class="security-right">
				<div class="security-right-title">
					<span class="security-right-title-text">电影管理</span>
				</div>
